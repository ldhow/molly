// src/shared/types/query-meta.ts
//
...
export type FeedbackMeta = {
   ...
   * communicates the failure inline — a login form rendering a field-level
   * error, or an optimistic update that rolls back visibly.
   */
